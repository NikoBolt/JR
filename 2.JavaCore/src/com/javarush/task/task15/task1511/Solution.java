...
public class Solution {
    ...
    public static class JavaDev /*1// extends Object*/ implements SpecificSerializable {
        String answerQuestion(String question) {
            return String.format("I'll be thinking of [%s]", question);
        }
    }

    public static class JuniorJavaDev extends /*2// Object,*/ JavaDev /*implements SpecificSerializable*/ {
